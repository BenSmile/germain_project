    ...
    <div>
      {
        ...
        (
          ...
          <Menu secondary color='red' size='huge'>
            <Menu.Item>
              <Image
            ...
            <Menu.Item as={Link} active={activeItem === 'home'} to="/" style={{ fontSize: 20 }}>Collect app</Menu.Item>
            ...
            <Menu.Item
              name='enquetes'
              active={activeItem === 'enquetes'}
              onClick={handleItemClick}
            />

            <Menu.Item
              name='profil' as={Link} to="/profil"
