...
export default class ListAbonnes extends Component {
    ...
    deleteAbonne(telephone) {
        AbonneService.deleteAbonne(telephone).then((res) => {
            this.setState({
                abonne: this.state.abonnes.filter(
    ...
    render() {
        ...
        return (
            ...
            <div className="row" style={{ marginTop: "10px" }}>
                ...
                <Link to="/addAbonne" className="btn btn-primary mb-3" style={{marginRight:"5px"}}>
                    <i className="fa fa-plus-circle">Import</i>
                </Link>
                <Link to="/addAbonne" className="btn btn-primary mb-3">
                    <i className="fa fa-plus-circle"> Export</i>
                </Link>
